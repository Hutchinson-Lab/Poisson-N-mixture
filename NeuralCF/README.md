I modified NCF codes to be applied to ecological datasets.

# How to run
```
python NeuMF.py --dataset hpi --metric auroc --batch_size 256 --num_factors 8 --layers [64,32,16,8] --reg_layers [0,0,0,0] --lr 0.0001 --verbose 10
```

----------------Below is the [modified version of NCF](https://github.com/Leavingseason/NeuralCF) -----------------------------
